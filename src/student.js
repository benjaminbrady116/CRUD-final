...
function Student(props){
 ...
 props.updateStudent(updatedStudent);
  ...
  return(
    <div className="card">
    <img src={props.student.Image} alt="pic" className='card-img-top mx-auto' />
    {!editMode &&  <ul className="list-group list-group-flush">
      ...
      <button type='button' className="btn btn-danger" onClick={() => props.removeStudent(props.student) }>Delete Computer<FontAwesomeIcon icon={faWarning} /></button>
